...
See sample: `handle-unknown-enum-ordinals-with-unknownvalueimplementation.good.al.txt`.
...
See sample: `handle-unknown-enum-ordinals-with-unknownvalueimplementation.bad.al.txt`.
